	...
	public class CreateOrderCommandValidator : AbstractValidator<CreateOrderCommand>
	{
		public CreateOrderCommandValidator()
		{
			RuleFor(o => o.UserName)
				...
				.MaximumLength(70)
				.WithMessage("{PropertyName} must not exceed 70 chars");

			RuleFor(o => o.TotalPrice)
				.NotEmpty()
				.WithMessage("{PropertyName} is required.")
				.GreaterThanOrEqualTo(0)
				.WithMessage("{PropertyName} shouldn't be negative");
			...
			RuleFor(o => o.FirstName).NotEmpty().WithMessage("{PropertyName} is required.");

			RuleFor(o => o.LastName).NotEmpty().WithMessage("{PropertyName} is required.");

			RuleFor(o => o.CardNumber)
				.CreditCard()
				.When(o => !string.IsNullOrEmpty(o.CardNumber))
